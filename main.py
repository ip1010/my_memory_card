...
question_list.append(Question('What is the most popular programming language for kids?', 'Scratch', 'C++', 'C#', 'JavaScript'))
question_list.append(Question('Which continent has never hosted the Olympic games?', 'South America', 'North America', 'Europe', 'Aisa'))
question_list.append(Question('Where does bubble tea, also known as pearl milk tea or boba milk tea originate from?', 'Taiwan', 'China', 'Japan', 'South Korea'))
question_list.append(Question('Who was the first person to go to space?', 'Yuri Gagarin', 'Neil Armstrong', 'Buzz Aldrin', 'Frank Borman'))
question_list.append(Question('Who was the first person on the moon?', 'Neil Armstrong', 'Buzz Aldrin', 'Michael Collins', 'William Anders'))
...
def check_answer():
    if answers[0].isChecked():
        ...
        window.setWindowTitle('Memo Card :D')
    else:
